...
var _addressComponents = require('../../../../../api/purchase/confirm/query/addressComponents');
...
describe('Purchase confirmation address component test', function () {

  it('should be a function that receives address parameters and returns a string with its data', function () {
    expect(_addressComponents2.default).to.be.a('function');
    ...
    expect((0, _addressComponents2.default)(adressDataTest)).be.deep.equal(expected);
  });
});
